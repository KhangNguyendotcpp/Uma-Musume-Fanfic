...
- **Tên:** South Heroine
- **Continuity:** `CINDERELLA_GRAY`
- **Vai trò xác nhận:** competitor trong race debut của Oguri Cap

Wiki/search source hiện không cung cấp standard profile; sau debut nhân vật không còn hiện diện đáng kể. Các field Japanese spelling, birth date, height, seiyuu, trainer, dorm/class và personality là `UNSPECIFIED` trong nguồn hiện truy cập.

Các liên hệ fandom với real horse chỉ là suy đoán và không được dùng làm canon.
...
- https://umamusu.wiki/South_Heroine
